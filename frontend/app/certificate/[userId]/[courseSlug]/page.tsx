    ...
    return (
        <div className="min-h-screen bg-rock-bg flex flex-col items-center justify-center px-6 py-16">
            <main className="w-full max-w-2xl">
                <article aria-label={`Certificate of Achievement for ${displayName}`}>
                    <div className="relative rounded-2xl border-2 border-rock-yellow/40 bg-[#0d0d0d] shadow-2xl overflow-hidden">
                        <div aria-hidden="true" className="h-1.5 w-full bg-gradient-to-r from-rock-yellow via-rock-orange to-rock-red" />
                        ...
                        <div className="px-10 py-12 text-center">
                            ...
                            <section aria-label="Completed lessons">
                                <h2 className="sr-only">Completed lessons</h2>
                                    ...
                                    {(cert.passed ?? []).map((lesson) => (
                                        <div key={lesson.slug} className="flex items-center justify-between">
                                            ...
                                            <span className={`text-sm font-black tabular-nums ${
                                                ...
                                                <span className="sr-only">Score: </span>{lesson.pct}%
                                            </span>
                                        </div>
                                    ))}
                                </div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="text-left">
                                    ...
                                    <p className="text-sm font-bold text-slate-300">
                                        <time dateTime={cert.issued_at}>{dateStr}</time>
                                    </p>
                                </div>
                                <div aria-hidden="true" className="h-16 w-16 rounded-full border-2 border-rock-yellow/40 flex items-center justify-center">
                        ...
                        <div aria-hidden="true" className="h-1.5 w-full bg-gradient-to-r from-rock-red via-rock-orange to-rock-yellow" />
                    </div>
                </article>
